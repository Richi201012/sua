...
function DocumentoGiraEvento({ onNext, onBack, onCancel }) {
  ...
  const handleFinalizar = () => {
    ...
    setTimeout(() => {
      setIsSaving(false);
      onNext(); // avanza al paso "registro"
    }, 1500);
  };
      ...
      >
        ...
        {showCancelModal && (
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-700 mb-6">
                Esto eliminará el archivo cargado.
              </p>
        ...
        {showConfirmFinish && (
          ...
          >
            ...
            >
              <h3 className="text-lg font-semibold mb-3">
                ¿Estás seguro de finalizar la captura?
              </h3>
              <div className="flex justify-end gap-3">
                <button
                  onClick={() => setShowConfirmFinish(false)}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-yellow-50 p-4 rounded-md text-sm text-gray-800">
                ...
                <ul className="list-disc ml-6 mt-1 space-y-1">
                  ...
                  <li>
                    Si son varias hojas deben ir agrupadas en un solo archivo
                    PDF
                  </li>
              ...
              <div className="border border-gray-300 rounded p-4 flex justify-between items-center flex-wrap gap-2">
  ...
  <div className="flex items-center gap-2 flex-1 min-w-0">
    ...
    {isLoadingPdf ? (
      ...
      archivo && (
        <span
          className="text-sm text-gray-700 truncate block min-w-0 max-w-full"
          title={archivo.name}
        >
          {archivo.name}
        </span>
