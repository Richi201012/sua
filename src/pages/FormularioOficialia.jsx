...
function FormularioOficialia() {
  ...
  const confirmSubmit = async () => {
    ...
    // ✅ Creamos la solicitud sin folios
    ...
    // 👇 Navegación directa a DocumentoOficialia
    navigate("/documento-oficialia");
  };
...
export default FormularioOficialia;
